	...
	*/
    ...
    if(pieceName.contains("Queen")){
      ...
      if(((landingX <0) || (landingX > 7)) || ((landingY < 0) || (landingY > 7))){
        ...
        if(((yMovement == 1)||(yMovement == 0))&&((xMovement == 0)||(xMovement==1))){    // it means king can only move one square on the x and y axis
          if(!piecePresent(e.getX(), e.getY())){
            validMove=true;
          }
            else{
    ...
    else if(pieceName.contains("Knight")){//taken from practical workbook
      if(((landingX < 0) || (landingX > 7)) ||((landingY < 0 ) || (landingY > 7))){
        validMove = false;
      }
      else{
      ...
      if(startY == 6){//where the pawn is makes its first move -- taken form vid tutorial
      ...
      else{//where pawn makes subsequent moves
      ...
      if(startY == 1){// where the pawn is makes its first move -- taken form vid tutorial
        if(((yMovement ==1 ) || (yMovement ==2 ))&& (startY < landingY) && (xMovement ==0)){
          if(yMovement == 2){
            if((!piecePresent(e.getX(),e.getY()) && (!piecePresent(e.getX(),e.getY()-75)))){
              validMove = true;
